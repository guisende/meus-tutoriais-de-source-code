...
class PlayState extends MusicBeatState
{
	...
	function setStageData(stageData:StageFile){
		...
		switch(curStage)
		{
			case 'nome da json do seu stage':
				stage1 = new FlxSprite(0, 0);
				stage1.loadGraphic(Paths.image("imagem aqui"));
				add(stage1); 
			
				stage2 = new FlxSprite(0, 0);
				stage2.loadGraphic(Paths.image("imagem aqui"));
				add(stage2); 
			
				stage3 = new FlxSprite(0, 0);
				stage3.loadGraphic(Paths.image("imagem aqui"));
				add(stage3); 
		}
	}
