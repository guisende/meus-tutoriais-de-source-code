...
class PlayState extends MusicBeatState
{
	...
	// - INTRO TIPO SONIC.EXE QUANDO COMEÇA A MUSICA LOL
	...
	override public function create()
	{
		...
		else
		{
			switch (daSong)
			{
				case 'bopeebo': //SUA MUSICA (PRA MAIS MUSICAS USSA ISSO) => ('exemplo1' | 'exemplo2' | 'exemplo3') e vai indo lol

					if (daSong == 'test') //ISSO SEVE QUANDO VOCE ENTRA NA MUSICA AI APARECE A INTRO E COMEÇA A MUSICA JUNTO (PRA MAIS MUISICAS USSA ISSO (daSong == 'exemplo1' || daSong == 'exemplo2')
						{
							startSong();
							startCountdown();
						}
					...
					add(blackFuck);
					startCircle.loadGraphic(Paths.image('IntroStart/Circle-'+ daSong)); //O INTROSTART E A PASTA DAS INTROS
					startCircle.x += 900;
					add(startCircle);
					startText.loadGraphic(Paths.image('IntroStart/Text-' + daSong));
					startText.x -= 1200;
					add(startText);
