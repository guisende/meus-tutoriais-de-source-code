...
class PlayState extends MusicBeatState
{
	...
	// - isso e o shader lol
	var euSouShader:ChomEffect;
	var euSouFiltroDoShader:ShaderFilter;
	...
	override public function create()
	{
		...
		super.create();
		euSouShader = new ChomEffect(0.01);
		add(euSouShader);
		euSouFiltroDoShader = new ShaderFilter(euSouShader.shader);
		//FlxG.camera.setFilters([euSouFiltroDoShader]);
		// - ou
		// camGame.setFilters([euSouFiltroDoShader]);
