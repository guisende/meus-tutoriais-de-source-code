...
class PlayState extends MusicBeatState
{
	...
	// mecanica tipo fatal error yeah
	...
	//mecanica pra janela voltar onde ele parou
	...
	override public function update(elapsed:Float)
	{
		...
		if (SONG.song.toLowerCase() == 'bopeebo' && IsWindowMoving) //ONDE TA BOPEEBO E SUA MUSICA
		{
	...
	override function stepHit()
	{
		...
		if (SONG.song.toLowerCase() == 'bopeebo') //ONDE TA BOPEEBO E SUA MUSICA //isso e como fosse script por step e so ir no chart editor e ver qual lugar vc quer!111!!!1
		{
			if (curStep == 3)
			{
				Xamount += 2; //pode colocar qualquer numero
				Yamount += 2; //pode colocar qualquer numero
				windowX = Lib.application.window.x;
				windowY = Lib.application.window.y;
				IsWindowMoving2 = true; //true pra sim e false pra nao
				IsWindowMoving = true; //true pra sim e false pra nao
			}
			if (curStep == 12)
			{
				IsWindowMoving2 = false; //true pra sim e false pra nao
				IsWindowMoving = false; //true pra sim e false pra nao
			}
			if (curStep == 20)
			{
				IsWindowMoving2 = true; //true pra sim e false pra nao
			...
			if (curStep == 28)
			{
				/*Xamount += 2; //se voce quer almentar e so copiar isso e mudar onde ta o 2
				Yamount += 2;
				windowX = Lib.application.window.x;
				windowY = Lib.application.window.y;*/
				IsWindowMoving2 = false; //true pra sim e false pra nao
	...
	function shakescreen() //JANELA TREME!!!!!!!!
	{
		new FlxTimer().start(0.01, function(tmr:FlxTimer)
		{
