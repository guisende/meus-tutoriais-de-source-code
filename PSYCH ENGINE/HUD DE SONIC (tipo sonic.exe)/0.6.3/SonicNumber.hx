...
class SonicNumber extends FlxSprite {
  ...
  public var folder(default, set):String = 'sonic1'; // - nome da pasta exemplo quero usar a font do sonic 1 entao escreva sonic1
  ...
  function set_folder(realVal:String){
    switch(realVal){
      /*case 'chaotix': // - se voce usar do chaotix tire o */ /*
