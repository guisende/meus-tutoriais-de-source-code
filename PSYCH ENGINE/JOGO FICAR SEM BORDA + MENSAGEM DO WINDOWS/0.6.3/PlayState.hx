		...
		if(SONG.song.toLowerCase() == 'bopeebo')
		{
			switch(curStep)
			{
				case 4:
					...
					Application.current.window.alert('shit fico sem borda kkk', 'omga jogo conversando bom tu');

				case 32:
					Application.current.window.borderless = false;
					Application.current.window.alert('oh no fico sem borda', 'omga jogo conversando bom tu');
