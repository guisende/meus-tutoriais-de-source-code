...
class PlayState extends MusicBeatState
{
	...
	function startSong():Void
	{
		...
		switch(curStage)
		{
			case 'stage': // onde esta o stage e o seu stage progamado aqui exemplo limo que esta ae
					#if windows
					try
					{
	...
	override public function update(elapsed:Float)
	{
		...
		switch (curStage)
		{
			...
			case 'stage': // ISSO E PRA FAZER O JOGO FICAR FOCADO E NAO DEIXAR O JOGO FICAR EM TELA CHEIA
				lime.app.Application.current.window.focus(); // windows ficar focado
				lime.app.Application.current.window.fullscreen = false; // nao deixar em tela cheia
				Application.current.window.fullscreen = false; // nao deixar em tela cheia
				Application.current.window.focus(); // windows ficar focado
		}
