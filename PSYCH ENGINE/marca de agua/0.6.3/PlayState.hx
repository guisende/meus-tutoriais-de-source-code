...
class PlayState extends MusicBeatState
{
	...
	var watermark:FlxText; // variavel de marca de agua
	...
	override public function create()
	{
		...
		watermark = new FlxText(scoreTxt.x + -70, scoreTxt.y, 0, "se quiser usse isso pra ports tipo (port by guisende)", -10000); // SUA MARCA DE AGUA
