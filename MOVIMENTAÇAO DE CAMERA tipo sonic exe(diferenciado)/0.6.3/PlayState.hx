...
class PlayState extends MusicBeatState
{
	...
	// - movimento da camera customizada yay
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'camtiltStrength': // - se voce for avançado voce pode fazer isso sem event!!111
				var val:Float = Std.parseFloat(value1);
				tiltStrength = val;
	
			case 'Cam Offset': // - se voce for avançado voce pode fazer isso sem event!!111
				var val:Float = Std.parseFloat(value1);
				var val2:Float = 0 - val;
				posOff = val;
				negOff = val2;

			case 'camera-speed': // - se voce for avançado voce pode fazer isso sem event!!111
				var cameraFloat:Float = Std.parseFloat(value1);
				cameraSpeed = cameraFloat;
		}
