...
class PlayState extends MusicBeatState
{
	...
	//public var ringsNumbers:Array<SonicNumber>=[]; // - isso e um test mais voce pode usar lol
	...
	var hudStyle:String = 'sonic2'; // - o hud default
	public var sonicHUDStyles:Map<String, String> = [
		"bopeebo" => "sonic2"

		// - ISSO E UM EXEMPLO
		//"sua musica" => "nome da font exemplo sonic3 ou sonic1 etc"
	];
	...
	override public function create()
	{
		...
		if(hudStyle == 'sonic2')hudFolder = 'sonic2'; // - SUA HUD!!!!
		...
		/*var ringsLabel:FlxSprite = new FlxSprite(15, 115).loadGraphic(Paths.image("sonicUI/" + hudFolder + "/rings")); // - ele funciona mais eu tirei pq n sei
		...
		// - numeros pra os rings e sim ele funciona again
		/*for(i in 0...3){
			var number = new SonicNumber(0, 0, 0);
			number.folder = hudFolder;
			number.setGraphicSize(Std.int(number.width*3));
		...
		// - minuto do seu ou segundos da sua musica pq idk
		...
		updateSonicScore();
		updateSonicMisses();
		//updateSonicRings(); // - se voce for usar os negocios de rings tire o // do updateSonicRings();
	...
	function updateSonicScore(){ // - os CAOS de funciton cool
	...
	function updateSonicMisses(){ // - sim e real fr
	...
	function noteMissPress(direction:Int = 1):Void //You pressed a key when there was no notes to press for this key
	{
		...
		if (!boyfriend.stunned)
		{
			...
			{
				songScore -= 10;
				updateSonicScore(); // - WOW MOMENTO LEGAL
			}
			if(!endingSong) {
				songMisses++;
				updateSonicMisses(); // - WOW MOMENTO LEGAL
			}
			totalPlayed++;
			RecalculateRating(true);
