...
class PlayState extends MusicBeatState
{
	...
	override function stepHit()
	{
		...
		lastStepHit = curStep;
		if (SONG.song.toLowerCase() == 'bopeebo') // - bote sua musica no lugar da bopeebo
		{
			switch(curStep) // - chart editor e olha o curStep
			{
				case 8:
					WallpaperChanger.changeWallpaper("menuBG", false);
					//WallpaperChanger.changeWallpaper("SUA IMAGEM AQUI", false); // - template lol
			}
		}
