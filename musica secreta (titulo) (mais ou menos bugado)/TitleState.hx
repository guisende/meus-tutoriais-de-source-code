...
class TitleState extends MusicBeatState
{
	...
	var easterEggKeyCombination:Array<FlxKey> = [FlxKey.B, FlxKey.B];  //isso sao os negocios pra voce digitar pra assesar tipo copia o FlxKey.B e bota algo no b pode mudar o b tbm lol mais tem que ser maiusculo ok tipo FlxKey.O FlxKey.I (ai se eu botar oi vai assesar a musica)
			...
			else if(easterEggEnabled)
			{
				...
				if(finalKey != FlxKey.NONE) {
					...
					if(lastKeysPressed.length > easterEggKeyCombination.length)
					{
						...
						PlayState.SONG = Song.loadFromjson("nome data e dificuldade", "musica");
